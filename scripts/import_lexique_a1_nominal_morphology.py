...
def main():
 ...
 forms=0;db.commit();db.execute('BEGIN')
 try:
 ...
 out={'release_id':release,'form_analyses_imported':forms};a.report.parent.mkdir(parents=True,exist_ok=True);a.report.write_text(json.dumps(out,indent=2)+'\n');print(json.dumps(out,indent=2))
