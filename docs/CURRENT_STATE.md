...
- The canonical schema now supports first-class `lexical_sense` objects linked from words, with independently evidenced English-gloss facts; source data has not yet been imported into that layer.
